...
import { updateCustomer, fetchRecordById, updateUser } from '../api/fetchapi';
...
const UpdateCustomerDetailsModal = ({
      ...
      if (CurrentCustomerId) {
        try {
          ...
          setFormData({
            ...
            modelType: customer.userDetails.Model_Type || '', // Updated field name
            stageName: customer.userDetails.Stage_Name || '', // Updated field name
            modelInstaLink: customer.userDetails.Model_Insta_Link || '', // Updated field name
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('user', id);
      const updatedCustomer = await updateCustomer(updatedData); // Pass the correct ID
    ...
    >
      ...
      >
        <div className='modalTopLine'>
          <h2 className='custName'>{formData.fullName || 'Customer'}</h2>
